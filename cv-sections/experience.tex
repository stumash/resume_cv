...
\cventry
{Software Engineering Intern - (PHP, Symphony, JQuery, Handlebars, Lodash)} % Job title
...
\cventry
{Data Science Intern(s) - (Python, SKlearn, R, SQL)} % Job title
